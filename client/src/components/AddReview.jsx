    ...
    <div className='mb-2'>
        <form action=''>
            ...
            <div className="form-group">
                ...
                <textarea value={reviewText} onChange={e => setReviewText(e.target.value)} className='form-control' name="" id="Review" cols="30" rows="10"></textarea>
            </div>
            <button onClick={handleSubmitReview} className="btn btn-primary" type='submit'>
                Submit
            </button>
        </form>
    </div>
